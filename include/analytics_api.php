...
//-------------------------------------------------------------------------------------------------
	 ...
	 */
	//---------------------------------------------------------------------------------------------
	public function data($id, $dimension, $metric, $sort = false, $filters = false, $start = false, $end = false, $max_results = 10, $start_index = 1) {
	//---------------------------------------------------------------------------------------------
		...
		$xml = $this->call("https://www.google.com/analytics/feeds/data?ids=$id&dimensions=$dimension&metrics=$metric&sort=$sort&filters=$filters&start-date=$start&end-date=$end&max-results=$max_results&start-index=$start_index");
