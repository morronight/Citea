...
function go(){
	...
	selDep = document.getElementById('lieuDep');
	selArr = document.getElementById('lieuArr');
	idGareDep = selDep.options[selDep.selectedIndex].value;
	idGareArr = selArr.options[selArr.selectedIndex].value;
...
function showLocation(position) {
	...
	if (position.coords.accuracy > 10000)
		document.getElementById("prec").innerHTML = "Precision : faible (≥ 10km près)";
	if ((position.coords.accuracy > 1000) && (position.coords.accuracy < 10000))
		document.getElementById("prec").innerHTML = "Precision : moyenne (≥ 1km près)";
	if (position.coords.accuracy < 1000)
		document.getElementById("prec").innerHTML = "Précision : bonne (≤ 1km près)";
